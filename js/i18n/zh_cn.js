...
let i18nDefault = i18nStrings.zh_cn = {
    ...
    */
    common: {
        ...
        hint_desc: "点击下方这个大大的 “{Draw}” 按钮，开始 {drawing} 吧！",
        hint_ios_title: "为了最佳体验：",
        hint_ios_desc: "按 {0} -> “添加到主屏幕” -> “添加”",
    },
    ...
    tabs: {
        ...
        options: {
            ...
            strings: {
                ...
                cloud_type_galaxy: "（已连接到 galaxy）",
                cloud_loggedOut: "（已登出）",
                cloud_state_saving: "（保存中……）",
                cloud_state_loading: "（加载中……）",
                cloud_state_checking: "（检查中……）",

                verb_desc: "更改与 {drawing} 卡片相关的动词，例如游戏标题和物品描述中的动词。",
                john_note: "（注意：链接将在此标签页中打开，按住 Ctrl+点击 以避免意外关闭游戏）",
            },
        },
    },
    ...
    */
    popups: {
        ...
        draw: {
            strings: {
                brand: "DTCGco.™",
                brand_full: "© DUDUCAT 交易卡片游戏公司",
                pack_title: "OMEGA CARDS",
                pack_subtitle: "交易卡牌游戏",
                pack_count: "{0} 张卡片包",
            },
        },
        currency: {
